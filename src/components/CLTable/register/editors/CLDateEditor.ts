 ...
 */
export interface CLDateEditorConfig extends Partial<DatePickerProps> {
 ...
 */
export class CLDateEditor implements IEditor {
  private config: CLDateEditorConfig;
  ...
  constructor(config: CLDateEditorConfig = {}) {
    this.config = {
      type: "date",
